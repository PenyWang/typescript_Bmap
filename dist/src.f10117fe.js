...
},{}],"src/MyMap.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  MyMap.prototype.render = function (divId, zoom) {
  ...
  MyMap.prototype.addMarker = function (mapableObj) {
    var _this = this;

    var point = new BMap.Point(mapableObj.longitude, mapableObj.latitude);
    var marker = new BMap.Marker(point);
    this.map.addOverlay(marker);

    marker.onclick = function () {
      _this.openInfoWindow(mapableObj);
    };
  };
  /**
   * 打开信息窗口
  ...
  MyMap.prototype.openInfoWindow = function (mapableObj) {
    var infoWindow = new BMap.InfoWindow(mapableObj.content, {
...
var MyMap_1 = __importDefault(require("./MyMap"));

var myMap = new MyMap_1.default(116.404 + "", 39.915 + "");
myMap.render('container', 5.5);
myMap.addMarker(new User_1.default('i am a user'));
myMap.addMarker(new Company_1.default('i am a company'));
},{"./User":"src/User.ts","./Company":"src/Company.ts","./MyMap":"src/MyMap.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
